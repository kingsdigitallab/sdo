AntXtras - WHAT IS IT?
======================
JWare/AntXtras Foundation (AntXtras) is a powerful
Ant extension library and a collection of very useful
add-on Ant components. AntXtras enhances Ant with a
set of new types, conditions, and tasks that make it
easier for you to use Ant to solve a great variety
of problems beyond simple application builds. Get
more information at http://antxtras.sourceforge.net/.
...
lib/
  Contains the AntXtras extension jar files. Only 
  the 'jw-antxtras.jar' file is required. The other 
