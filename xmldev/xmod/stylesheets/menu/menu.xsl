...
<xsl:stylesheet exclude-result-prefixes="#all" version="2.0" xmlns="http://www.w3.org/1999/xhtml"
  ...
  <xsl:template name="xmm:menu-item">
    <li>
      <xsl:choose>
        <xsl:when test="@href = $xmg:path or @root = $xmg:pathroot or contains($xmg:pathroot, @root)">
      ...
      <xsl:if test="child::* and (@href = $xmg:path or @root = $xmg:pathroot or contains($xmg:pathroot, @root))">
