...
class Collection(models.Model):
    ...
    identifier = models.CharField(max_length=15, blank=True, help_text=u"The code used to refer to this collection in shelfmarks and other identifying information")
...
class Container(models.Model):
    ...
    series = models.CharField(max_length=15, blank=True, help_text=u"As required, enter the series identifier for the container")
    box = models.CharField(max_length=15, blank=True, help_text=u"As required, enter the box identifier for the container")    
    folder = models.CharField("Folder", max_length=15, blank=True, help_text=u"As required, enter the folder identifier for the container") 
...
class DocumentStatements(models.Model):
    document_id = models.ForeignKey(Document, related_name='document_statements')
    statement_type = models.CharField(max_length=1, choices=STATEMENT_TYPES, help_text=u"Indicate the kind of statement being made about this container")
