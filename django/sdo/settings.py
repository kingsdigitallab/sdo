...
ADMIN_MEDIA_PREFIX = PROJECT_URL + 'dj_media/'

# Make this unique, and don't share it with anybody.
SECRET_KEY = 'ft29^%3t)bpql(#+rx_-yldg)o&2h2!f8p&)2n-x#ilc0(0q14'
...
LOGIN_REDIRECT_URL = PROJECT_URL + 'search/'

AUTH_PROFILE_MODULE = 'eats.UserProfile'
