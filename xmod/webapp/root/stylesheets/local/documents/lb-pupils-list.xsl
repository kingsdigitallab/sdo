<xsl:stylesheet version="2.0"
    ...
    <xsl:variable name="xmg:title"><xsl:text>Browse Lessonbooks By Pupil</xsl:text></xsl:variable>
    <xsl:variable name="root" select="/"/>
    
    <xsl:key name="alpha-tags" match="//str[@name='pupil']"
    ...
    <xsl:template name="xms:content">
        ...
        <xsl:for-each-group select="distinct-values(//str[@name='pupil'])"
