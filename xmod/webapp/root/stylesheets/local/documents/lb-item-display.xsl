    ...
    <xsl:template name="xms:pagehead">
        <div class="pageHeader">
            <div class="t01">
                ...
                <h3 class="documentDisplay"><xsl:value-of select="//sdo:recordCollection/sdo:record[@ID = $record]/sdo:itemDesc/dc:title"/></h3>
            </div>
        </div>
    </xsl:template>
    ...
    <xsl:template name="xms:content">
        <table class="docDisplayGandE">
            <tr>
                <td id="GermanVersion">
                    <!-- German version -->
                    <xsl:apply-templates select="//sdo:record[@ID = $record]/tei:div[@type='transcription']"/>
                </td>
                <td id="EnglishVersion">
                    <!-- English version -->
                    <xsl:apply-templates select="//sdo:record[@ID = $record]/tei:div[@type='translation']"/>
                </td>
            </tr>
            <tr>
                <td colspan="2">
