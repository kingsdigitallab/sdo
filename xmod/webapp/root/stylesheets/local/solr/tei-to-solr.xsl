...
<xsl:stylesheet exclude-result-prefixes="#all" version="2.0" xmlns="http://www.w3.org/1999/xhtml"
  ...
  <xd:doc scope="stylesheet">
    <xd:desc>
      ...
      <xd:p>This stylesheet is the local version of the default ../../xmod/solr/tei-to-solr.xsl. It has been heavily
        customised for SDO and currently overrides practically everything in the default.</xd:p>
    </xd:desc>
  </xd:doc>
